...
export function ProgramProjects({ slug }: { slug: string }) {
  ...
  return (
    <section className="py-4 md:py-8 lg:py-12 lg:min-h-screen flex flex-col justify-center bg-slate-50/50 border-y border-slate-100 overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col flex-1 justify-between gap-6 md:gap-10">
        
        {/* Top: Section Header & Full-Width Metadata Description */}
        <div className="w-full flex flex-col items-center sm:items-start text-center sm:text-left space-y-3">
        ...
        {/* Bottom: Tightly packed Cards Deck Area with custom responsive vertical gaps */}
        <div className="w-full flex-1 flex items-center justify-center overflow-visible py-2 mt-4 sm:mt-1">
          <div className="relative overflow-visible flex items-center justify-center h-[210px] sm:h-[240px] lg:h-[389px] w-full max-w-[640px] mt-6 sm:mt-0">
            <CardSwap 
              width={640} 
              height={389} 
              cardDistance={25} 
            ...
            >
              {projects.map((proj, idx) => (
                ...
                >
                  ...
                  {/* macOS Mockup Window Header (Centered dynamic text PROJECT 1, PROJECT 2, etc.) */}
