  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <GridBackgroundDemo className="h-full w-full py-6 md:py-10 lg:pt-8 lg:pb-8 relative overflow-hidden">
        ...
        <div className="w-full max-w-[90rem] mx-auto px-4 sm:px-6 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-0 lg:gap-4 relative z-50">
          
          {/* Left Column Content (Takes up 8 columns on large screens for more breathing room) */}
          <div className="lg:col-span-8 flex flex-col justify-center space-y-6 md:space-y-7 pt-8 pb-0 lg:py-12">
            <HeroHeading />
          ...
          <div className="lg:col-span-4 flex flex-col justify-center items-center lg:items-end relative pt-0 lg:pt-0 lg:translate-y-[-20px] mt-[-40px] lg:mt-0">
            ...
            <div className="w-full flex justify-center lg:justify-end mt-[-100px] lg:pr-14 relative z-20 lg:translate-y-[15px]">
              <div className="scale-[0.8] origin-center lg:origin-right">
                <NextBatchPill />
              </div>
            </div>
          </div>
